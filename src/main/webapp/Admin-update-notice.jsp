    ...
    <%@include file="adminNavbar.jsp" %>
        ...
        %>
                    ...
                    <div class="pending-admission">
                        <h2 class="approve-admis">Update Notice</h2>
                        <div class="add-teacher-form">

                            <form id="add-teacher-form" action="updateNotice" method="POST" >
                                <input type="hidden" name="noticeId" value="<%= noticeId %>" >
                                
                                <div class="form-group">
                                    <label for="teacher-name">Title</label>
                                    <input type="text" id="teacherName" name="noticeTitle" value="<%= noticeTitle %>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="email">Description</label>
                                    <input type="text" id="email" name="noticeDiscription" value="<%= noticeDiscription %>" required>
                                </div>
                                 ...
                                 <div class="form-group">
					                        ...
					                        <select name="noticeGrade" id="grade">
					                        	<option value="<%= noticeGrade %>" selected><%= noticeGrade %></option>
                               ...
                               <div class="form-group">
                                        ...
                                        <input type="date" id="event-date"name="noticePublishDate" value="<%= noticePublishDate %>">
                                    </div>
