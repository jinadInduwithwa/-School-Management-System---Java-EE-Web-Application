...
/**
 * Servlet implementation class allNotice
 */
...
public class allNotice extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		List<Notice> noticeDetails = NoticeDBUtil.getAllNotice();
		request.setAttribute("noticeDetails", noticeDetails);
		
		RequestDispatcher dis = request.getRequestDispatcher("Admin-notice.jsp");
